...
public class MainmenuPanel extends JPanel implements MouseListener {
	...
	public MainmenuPanel(MainFrame frame) {
		...
		buttons.add(new Button(0, 21, 250, 44, "Lernen", "button3", 3, 30));
		...
		buttons.add(new Button(0, 250, 250, 45, "Sprache Verwalten", "button8", 2.5, 20));
		buttons.add(new Button(0, 295, 250, 45, "Einstellungen", "button9", 2.5, 20));
		buttons.add(new Button(0, 340, 250, 45, "Statistiken", "button10", 2.5, 20));
		buttons.add(new Button(0, 385, 250, 45, "Hilfe", "button11", 2.5, 20));
		buttons.add(new Button(0, 430, 250, 45, "Info", "button12", 2.5, 20));
